 ...
 * The put and remove operations take O(n)
 * time in the worst case.
 * The contains, ceiling, floor,
 * and rank operations take O(log n) time in the worst
 * case.
 * The size, is-empty, minimum, maximum,
 * and select operations take O(1) time.
 * Construction takes O(1) time.
 * <p>
 * For alternative implementations of the symbol table API,
 * see { ST}, { BST}, { SequentialSearchST}, { RedBlackBST},
...
public class BinarySearchSymbolTable<Key extends Comparable<Key>, Value> {
    ...
    /**
     * Unit tests the {BinarySearchSymbolTable} data type.
     *
