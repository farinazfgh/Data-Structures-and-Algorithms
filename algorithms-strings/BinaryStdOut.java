/******************************************************************************
 *  Write binary data to standard output, either
 *  one 1-bit boolean,
 *  one 8-bit char,
 *  one 32-bit int,
 *  one 64-bit double,
 *  one 32-bit float,
 *  one 64-bit long at a time.
...
/**
 * Binary output.
 * This class provides methods for converting primtive type variables (boolean, byte, char, int, long, float, and double)
