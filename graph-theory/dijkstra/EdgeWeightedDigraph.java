...
/**
 * The {dijkstra.EdgeWeightedDigraph} class represents a edge-weighted digraph of vertices named 0 through V - 1, where each
...
public class EdgeWeightedDigraph {
    ...
    public EdgeWeightedDigraph(In in) {
        ...
        try {
            ...
            throw new IllegalArgumentException("invalid input format in dijkstra.EdgeWeightedDigraph constructor", e);
        }
    }
