 ...
 * The constructor takes &Theta;(E getNumberofVertices) time
 * in the worst case, where getNumberofVertices is the number of vertices and
 * E is the number of edges. In practice, it performs much better.
 * Each instance method takes &Theta;(1) time.
 * It uses &Theta;(getNumberofVertices) extra space (not including the
...
public class BellmanFordSP {
     ...
     * @throws IllegalArgumentException unless {0 <= s < getNumberofVertices}
     */
...
// Bellman-Ford algorithm
    ...
    private void findNegativeCycle() {
        int getNumberofVertices = edgeTo.length;
        EdgeWeightedDigraph spt = new EdgeWeightedDigraph(getNumberofVertices);
     ...
     * @throws IllegalArgumentException      unless {0 <= v < getNumberofVertices}
     */
